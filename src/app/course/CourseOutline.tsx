  ...
  return (
    <div>
      ...
      <h3 className="pb-3 text-xl text-secondary-content">Authors: {courseOutline.authors}</h3>
        ...
        <p className="font-medium text-base">Andamio is a new kind of platform for education and contribution management, and the best way to learn about it is by using it. This course is a hands-on example of how Andamio works.</p>
