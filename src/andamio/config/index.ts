...
import escrowAdminCircle from "../cardano/plutus/escrowAdminCircle.json";
import escrowAndamioCircle from "../cardano/plutus/escrowAndamioCircle.json";
import escrowBusinessCircle from "../cardano/plutus/escrowBusinessCircle.json";
import escrowProductCircle from "../cardano/plutus/escrowProductCircle.json";
import escrowRoadmapCircle from "../cardano/plutus/escrowRoadmapCircle.json";
...
export const andamioConfig: AndamioConfig<
  CourseManagementConfig & ProjectManagementConfig
> = {
  title: "Andamio PBL",
  baseAddress: "",
  enterpriseAddress: "",
